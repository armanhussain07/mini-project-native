...
export default function App() {
  ...
  useEffect(() => {
    setPosts([
      { id: 1, name: 'Ali hasan', role: 'Software Engineer at Google',
        text: 'Just shipped my first React Native app! 🚀', likes: 120, liked: false },
      { id: 2, name: 'Raza', role: 'Product Manager at Microsoft',
        text: 'Looking for a UI/UX designer for our startup. DM me if interested.', likes: 34, liked: true },
      { id: 3, name: 'Alina', role: 'Data Analyst at Amazon',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.profileName}>Arman Hussain</Text>
          <Text style={styles.profileRole}>React Native Developer</Text>
          <Text style={styles.profileStats}>100+ connections</Text>
        </View>
